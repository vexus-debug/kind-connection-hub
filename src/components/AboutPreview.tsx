...
const StatCard = memo(({ 
  ...
  return (
    <div ref={ref} className="text-center">
      <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-primary to-gold bg-clip-text text-transparent mb-2">
        {count}{suffix}
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                <div className="relative rounded-2xl overflow-hidden shadow-elegant aspect-[3/4]">
                  <img 
                    src={facialTreatment} 
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-elegant aspect-[3/4] mt-8">
                  <img 
                    src={salonInterior} 
                    alt="Faridaz Spa serene interior" 
                    className="w-full h-full object-cover"
                    loading="lazy"
                  />
                </div>
            ...
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold/10 border border-gold/20">
                ...
                <span className="text-sm font-medium">4.9★ Google Rating • Women-Owned</span>
              </div>

              <h2 className="text-3xl md:text-5xl font-bold text-foreground leading-tight">
                Your Sanctuary of Traditional Spa and Health Club
              </h2>

              <p className="text-lg text-muted-foreground leading-relaxed">
                Faridaz Spa is Abuja's sanctuary of calm, beauty, and complete well-being. 
                Our certified professional therapists deliver world-class treatments combining deeply therapeutic massages, scientifically advanced skincare, and comprehensive wellness rituals in a warm, serene atmosphere — creating a haven where your body, mind, and spirit are renewed.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-sm">
                    ...
                    <div className="text-xs text-muted-foreground">For Your Comfort</div>
                  </div>
                </div>
              </div>
