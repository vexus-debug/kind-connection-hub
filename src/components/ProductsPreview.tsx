  ...
  const featuredProducts = [
    {
      ...
      price: "From ₦40,000",
      description: "Deep moisturizing formula for 24-hour hydration"
    },
    {
      name: "Radiance Face Cream",
      price: "From ₦4,000",
      description: "Reduces fine lines and brightens skin tone"
    },
    {
      name: "Anti-Aging Shower Cream",
      price: "₦45,000",
      description: "Firms and rejuvenates skin with every shower"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold/10 border border-gold/20 mb-4">
              ...
              <span className="text-sm font-medium">Shop Our Products</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Extend your wellness journey at home with our curated selection of premium beauty and skincare products, carefully chosen to complement your spa treatments.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
            ...
            <div className="relative group cursor-pointer" onClick={() => navigate('/products')}>
              <div className="relative rounded-3xl overflow-hidden shadow-elegant">
                <img 
                  src="https://placehold.co/800x1000/e8d4b8/8b6f47?text=Beauty+Products"
                  alt="Faridaz Beauty Products"
                ...
                <div className="absolute inset-0 bg-primary/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="text-white text-center">
                    ...
                    <p className="text-lg font-semibold">View Products</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              {featuredProducts.map((product, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-primary to-gold rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
